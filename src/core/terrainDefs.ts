...
export const TERRAIN_DEFS: TerrainDefsMap = {
    ...
    plains: {
        ...
        variations: [
            ...
            { key: 'plains_stone_house', weight: 0, assetKey: 'house', walkable: false, connectsToRoad: true },
            { key: 'plains_glass_house', weight: 0, assetKey: 'house', walkable: false, connectsToRoad: true },
    ...
    dirt: {
        ...
        variations: [
            ...
            {key: 'dirt_stone_house', weight: 0, assetKey: 'house', walkable: false},
            {key: 'dirt_glass_house', weight: 0, assetKey: 'house', walkable: false},
