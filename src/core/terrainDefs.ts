...
export const TERRAIN_DEFS: TerrainDefsMap = {
    ...
    forest: {
        ...
        variations: [
            ...
            {key: 'young_forest', weight: 2, growth: {next: null, ageMsRange: [90000, 240000]}, overlayAssetKey: false},
    ...
    plains: {
        ...
        variations: [
            { key: 'road', weight: 0, moveCost: 0.6 },
            { key: 'road_ad', weight: 0, moveCost: 0.6 },
            { key: 'road_be', weight: 0, moveCost: 0.6 },
            { key: 'road_ce', weight: 0, moveCost: 0.6 },
            { key: 'road_cf', weight: 0, moveCost: 0.6 },
            { key: 'stone_road', weight: 0, moveCost: 0.35 },
            { key: 'stone_road_ad', weight: 0, moveCost: 0.35 },
            { key: 'stone_road_be', weight: 0, moveCost: 0.35 },
            { key: 'stone_road_ce', weight: 0, moveCost: 0.35 },
            { key: 'stone_road_cf', weight: 0, moveCost: 0.35 },
            { key: 'plains_wall', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_wall_ad', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_wall_be', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_wall_ce', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_wall_cf', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_stone_wall', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_stone_wall_ad', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_stone_wall_be', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_stone_wall_ce', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            { key: 'plains_stone_wall_cf', weight: 0, assetKey: 'plains', walkable: false, moveCost: 50 },
            ...
            { key: 'plains_food_storehouse', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_materials_yard', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_crop_silo', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_crafted_goods_storehouse', weight: 0, assetKey: 'plains', connectsToRoad: true },
            ...
            { key: 'plains_shop', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_trade_center', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_apiary', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_harbor', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_workshop', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_weapon_smith', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_library', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_barracks', weight: 0, assetKey: 'plains', connectsToRoad: true },
            { key: 'plains_oven', weight: 0, assetKey: 'plains_bakery', connectsToRoad: true },
            { key: 'plains_house', weight: 0, assetKey: 'house_wood', walkable: false, connectsToRoad: true },
            { key: 'plains_stone_house', weight: 0, assetKey: 'house_stone', walkable: false, connectsToRoad: true },
            { key: 'plains_glass_house', weight: 0, assetKey: 'house_glass', walkable: false, connectsToRoad: true },
    ...
    water: {
        ...
        variations: [
            ...
            {key: 'water_beacon', weight: 0, assetKey: 'water-v2', walkable: false, connectsToRoad: true},
    ...
    mountain: {
        ...
        variations: [
            ...
            {key: 'mountain_tunnel_cf', weight: 0, moveCost: 0.45, connectsToRoad: true, fencedEdges: { a: true, b: true, d: true, e: true }},
    ...
    dirt: {
        ...
        variations: [
            ...
            {key: 'dirt_wall', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_wall_ad', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_wall_be', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_wall_ce', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_wall_cf', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_stone_wall', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_stone_wall_ad', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_stone_wall_be', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_stone_wall_ce', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_stone_wall_cf', weight: 0, assetKey: 'dirt', walkable: false, moveCost: 50},
            {key: 'dirt_watchtower', weight: 0, assetKey: 'dirt'},
            {key: 'dirt_depot', weight: 0, assetKey: 'dirt'},
            {key: 'dirt_warehouse', weight: 0, assetKey: 'dirt'},
            {key: 'dirt_food_storehouse', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_materials_yard', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_crop_silo', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_crafted_goods_storehouse', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            ...
            {key: 'dirt_shop', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_trade_center', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_apiary', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_harbor', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_workshop', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_weapon_smith', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_library', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_barracks', weight: 0, assetKey: 'dirt', connectsToRoad: true},
            {key: 'dirt_oven', weight: 0, assetKey: 'dirt_bakery', connectsToRoad: true},
            {key: 'dirt_house', weight: 0, assetKey: 'house_wood', walkable: false},
            {key: 'dirt_stone_house', weight: 0, assetKey: 'house_stone', walkable: false},
            {key: 'dirt_glass_house', weight: 0, assetKey: 'house_glass', walkable: false},
    ...
    grapes: {
        ...
        overlayAssetKey: 'grapes_overhang',
        overlayOffset: { x: 0, y: 6 },
