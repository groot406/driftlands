...
const STORY_CHAPTERS: StoryChapterTemplate[] = [
  {
    ...
    nextHint: 'The shore crew is unloading building kits. Docks and shallows work from adjacent active shore, so a proper shelter and landing point would change everything.',
  },
  {
    ...
    briefing: 'The shore crew has brought dock timbers and house frames. Build a landing point from the active shoreline, raise the first shelter, and gather lily pads from the shallows so crews can lay the first safe steps over open water.',
  ...
  },
  {
    ...
    briefing: 'Build a granary to secure the harvest, raise a bakery so workers can turn grain into food, raise a watchtower to secure the perimeter, and get the docks producing fish. The colony needs reserves and vigilance before it can afford to grow.',
